...
/**
 * Unit tests for {@link SafeMessageSenderImpl}.
 *
 * @author Matt Champion 11/04/2017
 */
public final class SafeMessageSenderImplTest {
    @Mock
    ...
    @Test
    public void send() {
        final SafeMessageSender<String> sender = new SafeMessageSenderImpl<>(messagingControl, transformer);
