...
public final class BoundSafeMessageSenderBuilderImplTest {
    ...
    public void postConditions() {
        verifyNoMoreInteractions(transformer, unsafeTransformer, safeTransformer, messagingControl, json, sendCallback);
    }

    @Test
    public void transformAndSend() throws Exception {
        final BoundTransformedMessageSenderBuilder<String> builder =
            new BoundSafeMessageSenderBuilderImpl<>(messagingControl, transformer).transform(stringTransformer);
    ...
    public void transformWithAndSend() throws Exception {
        final BoundTransformedMessageSenderBuilder<String> builder =
            new BoundSafeMessageSenderBuilderImpl<>(messagingControl, transformer).transformWith(unsafeTransformer);
    ...
    public void safeTransformAndSend() throws Exception {
        final BoundSafeMessageSenderBuilder<String> builder =
            new BoundSafeMessageSenderBuilderImpl<>(messagingControl, transformer).transform(safeTransformer);
