...
public final class BoundSafeMessageSenderBuilderImplTest {
    ...
    public void transformAndSendToSession() throws Exception {
        final BoundTransformedMessageSenderBuilder<String> builder =
            new BoundSafeMessageSenderBuilderImpl<>(session, transformer).transform(stringTransformer);
    ...
    public void transformWithAndSendToSession() throws Exception {
        final BoundTransformedMessageSenderBuilder<String> builder =
            new BoundSafeMessageSenderBuilderImpl<>(session, transformer).transformWith(unsafeTransformer);
    ...
    @Test
    public void safeTransformAndSendToSession() throws Exception {
        final BoundSafeMessageSenderBuilder<String> builder =
            new BoundSafeMessageSenderBuilderImpl<>(session, transformer).transform(safeTransformer);
