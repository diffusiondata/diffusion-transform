...
/**
 * Unit tests for {@link MessageSenderImpl}.
 *
 * @author Matt Champion 11/04/2017
 */
public final class MessageSenderImplTest {
    @Mock
    ...
    public void send() throws Exception {
        final MessageSender<String> sender = new MessageSenderImpl<>(messagingControl, transformer);
