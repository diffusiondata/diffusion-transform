...
/**
 * Unit tests for {@link BoundTransformedMessageHandlerBuilderImpl}.
 *
 * @author Push Technology Limited
 */
public final class BoundTransformedMessageHandlerBuilderImplTest {
    ...
    public void transform() {
        final BoundTransformedMessageHandlerBuilder<String> builder =
            new BoundTransformedMessageHandlerBuilderImpl<>(contentTransformer, session);
