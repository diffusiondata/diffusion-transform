...
/**
 * Unit tests for {@link BoundSafeMessageHandlerBuilderImpl}.
 *
 * @author Push Technology Limited
 */
public final class BoundSafeMessageHandlerBuilderImplTest {
    @Mock
    ...
    public void transformSafe() {
        final BoundSafeMessageHandlerBuilder<String> builder =
            new BoundSafeMessageHandlerBuilderImpl<>(contentTransformer, session);
        final BoundSafeMessageHandlerBuilder<String> newBuilder = builder.transform(safeStringTransformer);
    ...
    public void transform() {
        final BoundSafeMessageHandlerBuilder<String> builder =
            new BoundSafeMessageHandlerBuilderImpl<>(contentTransformer, session);
        final BoundTransformedMessageHandlerBuilder<String> newBuilder = builder.transform(stringTransformer);
    ...
    public void transformWith() {
        final BoundSafeMessageHandlerBuilder<String> builder =
            new BoundSafeMessageHandlerBuilderImpl<>(contentTransformer, session);
        final BoundTransformedMessageHandlerBuilder<String> newBuilder = builder.transformWith(unsafeTransformer);
    ...
    public void register() {
        final BoundSafeMessageHandlerBuilder<String> builder =
            new BoundSafeMessageHandlerBuilderImpl<>(contentTransformer, session);
        builder.register("path", messageStream);
