...
public final class BoundTransformedMessageSenderBuilderImplTest {
    ...
    public void postConditions() {
        verifyNoMoreInteractions(transformer, unsafeTransformer, messaging, json, sendCallback);
    }

    @Test
    public void transformAndSend() throws Exception {
        final BoundTransformedMessageSenderBuilder<String> builder =
            new BoundTransformedMessageSenderBuilderImpl<>(messaging, transformer).transform(stringTransformer);
    ...
    public void transformWithAndSend() throws Exception {
        final BoundTransformedMessageSenderBuilder<String> builder =
            new BoundTransformedMessageSenderBuilderImpl<>(messaging, transformer).transformWith(unsafeTransformer);
