...
/**
 * Unit tests for {@link UnboundSafeMessageSenderBuilderImpl}.
 *
 * @author Push Technology Limited
 */
@SuppressWarnings("deprecation")
public final class UnboundSafeMessageSenderBuilderImplTest {
    @Mock
    ...
    public void transformAndSend() throws Exception {
        final UnboundTransformedMessageSenderBuilder<String> builder =
            new UnboundSafeMessageSenderBuilderImpl<>(transformer).transform(stringTransformer);
    ...
    public void transformWithAndSend() throws Exception {
        final UnboundTransformedMessageSenderBuilder<String> builder =
            new UnboundSafeMessageSenderBuilderImpl<>(transformer).transformWith(unsafeTransformer);
    ...
    public void safeTransformAndSend() throws Exception {
        final UnboundSafeMessageSenderBuilder<String> builder =
            new UnboundSafeMessageSenderBuilderImpl<>(transformer).transform(safeTransformer);
    ...
    public void bind() throws Exception {
        final BoundSafeMessageSenderBuilder<String> builder =
            new UnboundSafeMessageSenderBuilderImpl<>(transformer).bind(session);
    ...
    @Test
    public void safeTransformAndSendToHandler() throws Exception {
        final UnboundSafeMessageSenderBuilder<String> builder =
            new UnboundSafeMessageSenderBuilderImpl<>(transformer).transform(safeTransformer);
