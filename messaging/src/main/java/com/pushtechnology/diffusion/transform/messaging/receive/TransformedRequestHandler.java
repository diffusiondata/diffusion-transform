 ...
 */
public interface TransformedRequestHandler<T, U, V> extends Stream {

    /**
     * Notifies the stream of a transformed request.
     *
     * @param request the request that could not be transformed
     * @param requestContext the information about the request sender
     * @param responder a responder for the request
     */
    void onRequest(U request, RequestContext requestContext, Responder<V> responder);
