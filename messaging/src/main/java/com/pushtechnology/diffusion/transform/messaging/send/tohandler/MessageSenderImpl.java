...
/**
 * Implementation of {@link MessageSender}.
 *
 * @param <V> the type of values
 * @author Matt Champion 11/04/2017
 */
/*package*/ final class MessageSenderImpl<V> implements MessageSender<V> {
     ...
     * Constructor.
     */
    /*package*/ MessageSenderImpl(Messaging messaging, Transformer<V, ? extends Bytes> transformer) {
        this.messaging = messaging;
        this.transformer = transformer;
    }

    @Override
    public void send(String path, V message, SendCallback sendCallback) throws TransformationException {
