...
/**
 * Integration test for Binary topic adders.
 *
...
public final class AddBinaryTopicIT {
    ...
    public void addWithoutValue() throws TransformationException {
        ...
        final TopicAdder<BigInteger> topicAdder = binaryTopicAdderBuilder()
        ...
        assertEquals(BINARY, specificationCaptor.getValue().getType());
    ...
    public void addWithValue() throws TransformationException {
        ...
        assertEquals(BINARY, specification.getType());
        ...
        assertEquals(value, binaryToBigInteger().transform(valueCaptor.getValue()));
