 ...
 */
public final class SafeUpdateSourceAdapterTest {
    ...
    @Mock
    private SafeTransformedUpdater<JSON, JSON> valueUpdater;
    @Mock
    ...
    public void setUp() {
        ...
        adapter = new SafeUpdateSourceAdapter<>(valueCache, updaterBuilder, updateSource);
